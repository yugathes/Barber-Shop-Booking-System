...
<?php 	include "../Auth/connection.php";
	...
	<div class="topnav">
		...
		<a <?php if (basename($_SERVER['PHP_SELF']) == "staff.php") echo "class='active'"?> href="staff.php">Staff</a>
		<a <?php if (basename($_SERVER['PHP_SELF']) == "customer.php") echo "class='active'"?> href="customer.php">Customer</a>
		<a <?php if (basename($_SERVER['PHP_SELF']) == "booking.php") echo "class='active'"?> href="booking.php">Booking</a>
		<a <?php if (basename($_SERVER['PHP_SELF']) == "event.php") echo "class='active'"?> href="event.php">News & Events</a>
	</div>
	<div class="auth">
