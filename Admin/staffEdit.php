	...
	<div class="wrapper">
		<div class="middle">
			...
			<form class = "content" style="position:absolute;width: 40%;" action="Update.php" name="EditForm" method="POST">
				<h1 class="header">Customer Profile</h1>
...
<label>Username</label>
						...
						<label>Address</label>
						<textarea rows="5" cols="45" name="address" value="<?php echo $baris['address']; ?>"><?php echo $baris['address']; ?></textarea><br><br>
						<input type="hidden" name="username" value="<?php echo $name;?>">
						<button style="position: relative;left: 80%"; type="submit" class="btn" name="staffAdm">Update</button>
					</div> <?php	}?>
			</form>
			</div>
		</div>
